...
dicty_total = read_excel(file.choose(), 
  ...
  mutate(Plasmid = factor(Plasmid, levels = c("pDTi516", "pDTi571", "pDTi500"))) 
...
mytable_actin = cbind(totalcell_details[1:7], filopercell_details[3:4], filo_length_details[3:4]) %>% 
  filter(Cell_Line %in% c("AX2", "G120", "dDia2", "VASP")) 
mytable_actin

mytable_mhcA = cbind(totalcell_details[1:7], filopercell_details[3:4], filo_length_details[3:4]) %>% 
